...
namespace sUpdater
{
    ...
    {
        public static Brush normalGreenBrush = new SolidColorBrush(Color.FromRgb(0, 186, 0));
        public static Brush hoverGreenBrush = new SolidColorBrush(Color.FromRgb(0, 226, 0));
